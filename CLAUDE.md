...
### 1. 인플루언서 시그널 (기존)
- 20개 채널, 2,688건 시그널, 32 speakers
- 파이프라인: batch_pipeline.py (자막추출→GPT-4o/Sonnet분석→DB→수익률)
- Eval 정확도: 78.3% (V15.0 프롬프트 + GPT-4o, 69건 기준)
- 비종목 블랙리스트: scripts/qa/stock_blacklist.json (35개 항목)
...
## 현재 상태 (2026-04-05)
- 인플루언서 시그널: 2,688건 (20개 채널, 비종목 201건 정리 완료)
- 프롬프트: V15.0 운영 (비종목 제외 + 타인 인용 구분, GPT-4o 78.3%)
- 내부자 거래: 153,764건 (전체 상장사 783개 종목)
- 애널리스트 리포트: 45종목 3년치
- 수급 데이터: KR 121종목
