  ...
  return (
    <div className="space-y-6">
      ...
      {newBuys.length > 0 && (
        <div>
          <h4 className="flex items-center gap-2 text-lg font-semibold text-gray-900 mb-3">
            <span className="text-green-500">?윟</span>
            ?덈줈 ??寃?          </h4>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-bold text-gray-900">
                      {stock.name} {stock.ticker && !/^\d+$/.test(stock.ticker) && !stock.name.includes(`(${stock.ticker})`) && <span className="text-gray-500 font-normal">({stock.ticker})</span>}
                    </div>
                  </div>
      ...
      {increased.length > 0 && (
        <div>
          <h4 className="flex items-center gap-2 text-lg font-semibold text-gray-900 mb-3">
            <span className="text-blue-500">?뵾</span>
            ????寃?          </h4>
      ...
      {decreased.length > 0 && (
        <div>
          <h4 className="flex items-center gap-2 text-lg font-semibold text-gray-900 mb-3">
            <span className="text-orange-500">?뵿</span>
            以꾩씤 寃?          </h4>
          <div className="space-y-2">
      ...
      {soldAll.length > 0 && (
        <div>
          <h4 className="flex items-center gap-2 text-lg font-semibold text-gray-900 mb-3">
            <span className="text-red-500">?뵶</span>
            ????寃?          </h4>
