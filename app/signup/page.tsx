...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setSuccess('인증 이메일을 확인해주세요! 이메일 확인 후 로그인할 수 있습니다.');
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#f4f4f4] flex items-center justify-center px-4">
      <div className="w-full max-w-[400px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#8b95a1] text-sm mt-1">투자 커뮤니티에 참여하세요</p>
        </div>

        {/* Card */}
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h2 className="text-xl font-bold text-[#191f28] mb-6">회원가입</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-[#4e5968] mb-1.5">비밀번호 확인</label>
              <input
                type="password"
